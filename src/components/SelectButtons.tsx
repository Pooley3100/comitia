    ...
    return (
        <div className='w-full h-full flex justify-center items-center text-black font-roman'>
            <div className='w-full xl:w-4/5 h-4/5 flex flex-row justify-center gap-5 items-center'>
                ...
                <button className={`w-1/3 2xl:w-1/5 h-1/2 ${showTextQ ? "bg-black bg-opacity-50" : "bg-red-500"} rounded-lg shadow-lg text-center`} onMouseEnter={() => setShowText(true, 'question')} onMouseLeave={() => setShowText(false, 'question')} onClick={() => formSet('qAndA')}>
                ...
                <button className={`w-1/3 2xl:w-1/5 h-1/2 ${showTextP ? "bg-black bg-opacity-50" : "bg-yellow-400"} rounded-lg shadow-lg text-center`} onMouseEnter={() => setShowText(true, 'poll')} onMouseLeave={() => setShowText(false, 'poll')} onClick={() => formSet('poll')}>
